...
<?php echo $this->Form->create('BlogTermLink'); ?>
	<fieldset>
		<legend><?php echo __('Edit Blog Term Link'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BlogTermLink.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BlogTermLink.id'))); ?></li>
