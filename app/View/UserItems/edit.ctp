...
<?php echo $this->Form->create('UserItem'); ?>
	<fieldset>
		<legend><?php echo __('Edit User Item'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserItem.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UserItem.id'))); ?></li>
