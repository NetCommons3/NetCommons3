...
<?php echo $this->Form->create('PageColumn'); ?>
	<fieldset>
		<legend><?php echo __('Edit Page Column'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PageColumn.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PageColumn.id'))); ?></li>
