...
<?php echo $this->Form->create('UserItemLink'); ?>
	<fieldset>
		<legend><?php echo __('Edit User Item Link'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserItemLink.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UserItemLink.id'))); ?></li>
