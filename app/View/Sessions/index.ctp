<div class="sessions index">
	...
	<tr>
		<td><?php echo h($session['Session']['id']); ?>&nbsp;</td>
		<td><?php echo h($session['Session']['data']); ?>&nbsp;</td>
		<td><?php echo h($session['Session']['expires']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $session['Session']['id']), null, __('Are you sure you want to delete # %s?', $session['Session']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
