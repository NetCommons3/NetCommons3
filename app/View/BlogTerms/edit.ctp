...
<?php echo $this->Form->create('BlogTerm'); ?>
	<fieldset>
		<legend><?php echo __('Edit Blog Term'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BlogTerm.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BlogTerm.id'))); ?></li>
