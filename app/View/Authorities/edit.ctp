...
<?php echo $this->Form->create('Authority'); ?>
	<fieldset>
		<legend><?php echo __('Edit Authority'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Authority.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Authority.id'))); ?></li>
