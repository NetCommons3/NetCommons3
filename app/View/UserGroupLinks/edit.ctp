...
<?php echo $this->Form->create('UserGroupLink'); ?>
	<fieldset>
		<legend><?php echo __('Edit User Group Link'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserGroupLink.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UserGroupLink.id'))); ?></li>
