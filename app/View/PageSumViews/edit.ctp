<div class="pageSumViews form">
<?php echo $this->Form->create('PageSumView'); ?>
	<fieldset>
		<legend><?php echo __('Edit Page Sum View'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PageSumView.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PageSumView.id'))); ?></li>
