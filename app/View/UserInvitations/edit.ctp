...
<?php echo $this->Form->create('UserInvitation'); ?>
	<fieldset>
		<legend><?php echo __('Edit User Invitation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserInvitation.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UserInvitation.id'))); ?></li>
