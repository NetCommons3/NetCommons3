...
<?php echo $this->Form->create('BlogComment'); ?>
	<fieldset>
		<legend><?php echo __('Edit Blog Comment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BlogComment.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BlogComment.id'))); ?></li>
