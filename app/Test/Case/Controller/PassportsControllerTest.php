...
App::uses('PassportsController', 'Controller');

/**
 * Summary for PassportsController Test Case
 */
class PassportsControllerTest extends ControllerTestCase {
