<?php
/**
 * BlogTermLinksController Test Case
 *
...
App::uses('BlogTermLinksController', 'Controller');

/**
 * Summary for BlogTermLinksController Test Case
 */
class BlogTermLinksControllerTest extends ControllerTestCase {
