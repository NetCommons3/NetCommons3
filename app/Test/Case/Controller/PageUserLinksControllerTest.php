<?php
/**
 * PageUserLinksController Test Case
 *
...
App::uses('PageUserLinksController', 'Controller');

/**
 * Summary for PageUserLinksController Test Case
 */
class PageUserLinksControllerTest extends ControllerTestCase {
