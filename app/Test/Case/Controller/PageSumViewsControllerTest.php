<?php
/**
 * PageSumViewsController Test Case
 *
...
App::uses('PageSumViewsController', 'Controller');

/**
 * Summary for PageSumViewsController Test Case
 */
class PageSumViewsControllerTest extends ControllerTestCase {
