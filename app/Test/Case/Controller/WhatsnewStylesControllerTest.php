<?php
/**
 * WhatsnewStylesController Test Case
 *
...
App::uses('WhatsnewStylesController', 'Controller');

/**
 * Summary for WhatsnewStylesController Test Case
 */
class WhatsnewStylesControllerTest extends ControllerTestCase {
