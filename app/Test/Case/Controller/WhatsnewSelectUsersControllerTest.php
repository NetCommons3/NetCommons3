<?php
/**
 * WhatsnewSelectUsersController Test Case
 *
...
App::uses('WhatsnewSelectUsersController', 'Controller');

/**
 * Summary for WhatsnewSelectUsersController Test Case
 */
class WhatsnewSelectUsersControllerTest extends ControllerTestCase {
