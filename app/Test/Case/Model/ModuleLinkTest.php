...
/**
 * Summary for ModuleLink Test Case
 */
class ModuleLinkTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ModuleLink = ClassRegistry::init('ModuleLink');
	}
