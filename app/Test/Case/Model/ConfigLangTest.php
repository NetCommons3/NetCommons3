...
/**
 * Summary for ConfigLang Test Case
 */
class ConfigLangTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ConfigLang = ClassRegistry::init('ConfigLang');
	}
