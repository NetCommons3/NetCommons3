...
/**
 * Summary for UploadLink Test Case
 */
class UploadLinkTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->UploadLink = ClassRegistry::init('UploadLink');
	}
